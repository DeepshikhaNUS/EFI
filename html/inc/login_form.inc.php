...
<div id="login-form" class="login-form hidden">
    <div style="margin-bottom:15px">Sign in or <a href="<?php echo $SiteUrlPrefix; ?>/request_account.php?action=create">request for an account</a> to view previous job history.</div>
    <table border="0">
        <tbody>
